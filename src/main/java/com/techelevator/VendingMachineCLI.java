...
public class VendingMachineCLI {
	...
	public void run() {
		while (true) {
			...
			String choice = (String) menu.getChoiceFromOptions(restockMachine, MAIN_MENU_OPTIONS);
			...
			if (choice.equals(MAIN_MENU_OPTION_DISPLAY_ITEMS)) {
				...
				SalesReport.displayTotalSales("\nTotal Sales : $" + VendingMachine.allSales, VendingMachine.allSalesReport);
				System.exit(1);
			}
		}
	}
